...
const Font_t Font_5x8 = {
                            FONT_5_BY_8_WIDTH_PX,   // widthPx
                            FONT_5_BY_8_HEIGHT_PX,  // heightPx
                            fontChars_5x8           // *fontChars[];
                        };



const uint8_t fontChars_5x8[][(FONT_5_BY_8_WIDTH_PX * FONT_5_BY_8_HEIGHT_PX) /8] = {
// Bit mappings for some ASCII characters
